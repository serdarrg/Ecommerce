#pragma checksum "C:\Users\z0048j5a\Source\Repos\Ecommerce\Views\Home\Dashboard.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2c961e634927aa70127b66f51d8ed0e5a82624b7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2c961e634927aa70127b66f51d8ed0e5a82624b7", @"/Views/Home/Dashboard.cshtml")]
  ...
  ");
            WriteLiteral(@"                  <div class=""widget-rounded-circle card-box"">
                        <div class=""row"">
                            <div class=""col-6"">
            ...
            WriteLiteral(@"       <div class=""widget-rounded-circle card-box"">
                ...
                <div class=""col-md-6 col-xl-3"">
                    <div class=""w");
            WriteLiteral(@"idget-rounded-circle card-box"">
                        <div class=""row"">
                            <div class=""col-6"">
            ...
            <div class=""row"">
                <div class=""col-xl-8"">
     ");
            WriteLiteral(@"               <div class=""card-box pb-2"">
            ...
            WriteLiteral(@"          <!-- item-->
                        ...
                        <div class=""widget-chart text-center"" dir=""ltr"">
                            ...
                            <div class=""row mt-4"">
                                <div class=""col-4"">
                                   ");
            WriteLiteral(@" <p class=""text-muted font-15 mb-1 text-truncate"">Target</p>
                            ...
                            <table class=""table table-centered table-hover mb-0"">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                    ");
            WriteLiteral(@"        <img src=""/images/users/user-2.jpg"" alt=""user-pic"" class=""rounded-circle avatar-sm bx-shadow-lg"" />
                                            <span class=""ml-2"">Imelda J. Stanberry</span>
                                        </td>
                                        <td>
                                            <img src=""/images/cards/visa.png"" alt=""user-card"" height=""24"" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/users/user-3.jpg"" alt=""user-pic"" class=""rounded-circle avatar-sm bx-shado");
            WriteLiteral(@"w-lg"" />
                                            <span class=""ml-2"">Francisca S. Lobb</span>
                                        </td>
                                        <td>
                                            <img src=""/images/cards/master.png"" alt=""user-card"" height=""24"" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/users/user-1.jpg"" alt=""user-pic"" class=""rounded-circle avatar-sm bx-shadow-lg"" />
                                            <span class=""ml-2"">James A. Wert</span>
      ");
            WriteLiteral(@"                                  </td>
                                        <td>
                                            <img src=""/images/cards/amazon.png"" alt=""user-card"" height=""24"" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/users/user-4.jpg"" alt=""user-pic"" class=""rounded-circle avatar-sm bx-shadow-lg"" />
                                            <span class=""ml-2"">Dolores J. Pooley</span>
                                        </td>
                                        <td>
                ");
            WriteLiteral(@"                            <img src=""/images/cards/american-express.png"" alt=""user-card"" height=""24"" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/users/user-5.jpg"" alt=""user-pic"" class=""rounded-circle avatar-sm bx-shadow-lg"" />
                                            <span class=""ml-2"">Karen I. McCluskey</span>
                                        </td>
                                        <td>
                                            <img src=""/images/cards/discover.png"" alt=""user-card"" heig");
            WriteLiteral(@"ht=""24"" />
            ...
            WriteLiteral(@">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src=""/images/products/product-1.png"" alt=""product-pic"" height=""36"" />
   ...
   ");
            WriteLiteral(@"                                     <td>27.03.2018</td>
                                        <td>$345.98</td>
                                        <td><span class=""badge bg-soft-success text-success"">Active</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src=""/images/products/product-2.png"" alt=""product-pic"" height=""36"" />
            ...
            WriteLiteral(@"               </tr>
                                    <tr>
                                        <td>
                                            <img src=""/images/products/product-3.png"" alt=""product-pic"" height=""36"" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/products/product-4.png"" alt=""product-pic"" height=""36"" />
                    ");
            WriteLiteral(@"                        <span class=""ml-2"">Designer Awesome Chair</span>
                                        </td>
                                        <td>
                                            Wing Chairs
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src=""/images/products/product-5.png"" alt=""product-pic"" height=""36"" />
